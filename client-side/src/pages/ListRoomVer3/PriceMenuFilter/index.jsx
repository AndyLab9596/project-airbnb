...
import { FILTER_BY_PRICE } from '../../../store/types/ListRoomType';
import { AirbnbSlider, AirbnbThumbComponent, PriceInputField, useStyles } from "./style";

const PriceMenuFilter = (props) => {
    const { priceValue, setPriceValue, handleChangePriceValue, handleChangeInputField } = props;
    ...
    const handleClosePrice = () => {
        ...
        // dispatch(createAction(FILTER_BY_PRICE, priceValue))
    };
