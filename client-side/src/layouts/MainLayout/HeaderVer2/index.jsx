import {
    AppBar, Avatar, Badge, ClickAwayListener, Grow, MenuItem, MenuList, Paper, Popper, useMediaQuery
            ...
            <ClickAwayListener onClickAway={handleClickAwayListener}>
                <AppBar
                    ...
                    className={clsx(
                        ...
                        { [classes.appBarStaticDetail]: detailPagePath || profilePagePath },
                        { [classes.appBarStaticPay]: payPagePath }
                    )}
                >
                    <div className={classes.wrapper}>
                        ...
                        <div className={classes.profile}>
                            ...
                            <button className={clsx(
                                ...
                                { [classes.list__profile__btn]: listPagePath || detailPagePath || profilePagePath },
                            ...
                            <button className={clsx(
                                ...
                                { [classes.list__profile__language]: listPagePath || detailPagePath || profilePagePath },
                            ...
                            <button
                                className={clsx(classes.profile__menuToggle, { [classes.pay__profile__menuToggle]: payPagePath })}
                                ref={anchorRef}
                                        ...
                                        <MenuList autoFocusItem={openMenu} id="menu-list-grow" className={classes.menuList}>
                                            {isUserId ? (
                                                <>
                                                    ...
                                                    <MenuItem className={classes.menuItem}>Cho thuê nhà</MenuItem>
                                                    ...
                                                    <MenuItem className={classes.menuItem}>Trải nghiệm</MenuItem>
                                                    <MenuItem className={classes.menuItem}>Trợ giúp</MenuItem>
                    ...
                    <div className={clsx(
                        ...
                        { [classes.pay__searchBar]: payPagePath },
                        {
                            [classes.hideSearchBar]: !displaySearchBar,
                        }
                    )}>
                        <SearchBarVer2 setDisplaySearchBar={setDisplaySearchBar} queryParams={queryParams} />
                    </div>
